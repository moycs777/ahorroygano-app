...
export class HomePage {
  ...
  /* logoutTW(){
    this.tw.logout().then(this.onLogoutSuccess, this.onLogoutError);
  } */
  doLogin() {
    this.showLoader();
  ...
  loginTW(): void {
    this.presentToast("twitter :");
    //this.tw.login().then(this.onSucTw, this.onErrorTw);
    this.tw.login().then(
      response => {
        this.presentToast("respuesta :" + JSON.stringify(response));
        //this.user = response;
        this.apiLogTw(response);
      },
      error => {
  ...
  onSucTw(response) {
    ...
    this.presentToast("respuesta :" + JSON.stringify(this.user));
  ...
  onErrorTw(response){
    this.presentToast("error :" + JSON.stringify(response));
